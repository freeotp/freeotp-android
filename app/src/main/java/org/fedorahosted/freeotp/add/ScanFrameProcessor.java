        ...
        MAIN_THREAD_HANDLER.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    try {
                            res = reader.decode(new BinaryBitmap(new HybridBinarizer(ls)));
                    ...
                    if (res == null) {
                            res = reader.decode(new BinaryBitmap(new HybridBinarizer(ls.invert())));
                    }

                    sendTextToActivity(res.getText());
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
